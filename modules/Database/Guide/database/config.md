...
The default config file is located in `MOD_PATH/database/config/database.php`.  You should copy this file to `APP_PATH/config/database.php` and make changes there, in keeping with the [cascading filesystem](../kohana/files).
