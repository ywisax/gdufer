...
The database module is included with the Kohana 3.0 install, but needs to be enabled before you can use it. To enable, open your `APP_PATH/Init.php` file and modify the call to [Kohana::module] by including the database module like so:
