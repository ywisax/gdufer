...
class Kohana_Pagination {
	...
	public function url($page = 1)
	{
		...
		switch ($this->config['current_page']['source'])
		{
			case 'query_string':
				return URL::site(
					//$this->_route->uri($this->_route_params).
					$this->_request->uri().
					$this->query(array(
	...
	{
		$params = ($params === NULL)
			? $this->_request->query() // Use only the current parameters
			: array_merge($this->_request->query(), $params); // Merge the current and new parameters
