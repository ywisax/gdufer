...
class Kohana_Cache_Sqlite extends Cache implements Cache_Tagging, Cache_GarbageCollect {
	...
	protected function __construct(array $config)
	{
		...
		$database = Helper_Array::get($this->_config, 'database', NULL);
		...
		if (0 == count($result))
		{
			$database_schema = Helper_Array::get($this->_config, 'schema', NULL);
			...
			try
			{
				...
				$this->_db->query(Helper_Array::get($this->_config, 'schema', NULL));
			}
	...
	public function set_with_tags($id, $data, $lifetime = NULL, array $tags = NULL)
	{
		...
		if ($lifetime === NULL)
		{
			$lifetime = (0 === Helper_Array::get($this->_config, 'default_expire', NULL)) ? 0 : (Helper_Array::get($this->_config, 'default_expire', Cache::DEFAULT_EXPIRE) + time());
		}
		else
		{
