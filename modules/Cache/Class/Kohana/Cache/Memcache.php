...
class Kohana_Cache_Memcache extends Cache implements Cache_Arithmetic {
	...
	protected function __construct(array $config)
	{
		...
		$servers = Helper_Array::get($this->_config, 'servers', NULL);
		...
		// SAEÃ²ËÆ½ûÓÃÁËMemcache::addServer
		if ( ! IN_SAE)
		{
		...
		// Setup the flags
		$this->_flags = Helper_Array::get($this->_config, 'compression', FALSE) ? MEMCACHE_COMPRESSED : FALSE;
	}
