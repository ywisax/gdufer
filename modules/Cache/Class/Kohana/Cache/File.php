 ...
 *                  'cache_dir'     => APP_PATH.'Cache/.kohana_cache', // Cache location
 *           ),
 *     )
 *
...
class Kohana_Cache_File extends Cache implements Cache_GarbageCollect {
	...
	protected function __construct(array $config)
	{
		...
		try
		{
			$directory = Helper_Array::get($this->_config, 'cache_dir', Kohana::$cache_dir);
	...
	public function set($id, $data, $lifetime = NULL)
	{
		...
		if ($lifetime === NULL)
		{
			...
			$lifetime = Helper_Array::get($this->_config, 'default_expire', Cache::DEFAULT_EXPIRE);
		}
