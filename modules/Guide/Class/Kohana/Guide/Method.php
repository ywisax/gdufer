 ...
 */
class Kohana_Guide_Method extends Guide {
	...
	/**
	 * @var  array    array of Guide_Method_Param
	 */
	public $params;
	...
	public function __construct($class, $method)
	{
		...
		list($this->description, $tags) = Guide::parse($comment);

		if ($file = $this->class->getFileName())
		{
			$this->source = Guide::source($file, $this->method->getStartLine(), $this->method->getEndLine());
		}
		...
		if (isset($tags['param']))
		{
			...
			{
				$param = new Guide_Method_Param(array($this->method->class, $this->method->name), $i);
