...
<div id="Kohana_error">
	...
	<div id="error4ac2453378034" class="content">
		<p><span class="file">SYS_PATH/Class/Kohana/view.php [ 215 ]</span></p>
		<pre class="source"><code><span class="line"><span class="number">210</span> 	 */
...
</span><span class="line"><span class="number">213</span> 		if (($path = Kohana::find_file('View', $file)) === FALSE)
				...
				<p>
					...
					<span class="file">
													<a href="#error4ac2453378034source0" onclick="return koggle('error4ac2453378034source0')">SYS_PATH/Class/Kohana/view.php [ 115 ]</a>
											</span>
					&raquo;
				...
				<p>
					<span class="file">
													<a href="#error4ac2453378034source1" onclick="return koggle('error4ac2453378034source1')">SYS_PATH/Class/Kohana/view.php [ 26 ]</a>
											</span>
					&raquo;
				...
				<p>
					...
					<span class="file">
													<a href="#error4ac2453378034source2" onclick="return koggle('error4ac2453378034source2')">SYS_PATH/Class/Kohana/controller/template.php [ 32 ]</a>
											</span>
					&raquo;
				...
				<p>
					<span class="file">
													<a href="#error4ac2453378034source4" onclick="return koggle('error4ac2453378034source4')">SYS_PATH/Class/Kohana/request.php [ 840 ]</a>
											</span>
					&raquo;
    ...
    <small>public</small> request => <small>object</small> <span>Request(9)</span> <code>{
        ...
        <small>protected</small> _params => <small>array</small><span>(0)</span> 
				...
				<p>
					<span class="file">
													<a href="#error4ac2453378034source6" onclick="return koggle('error4ac2453378034source6')">WEB_PATH/index.php [ 106 ]</a>
											</span>
					&raquo;
					...
					<table cellspacing="0">
											<tr>
							<td><code>0</code></td>
							<td><pre><small>string</small><span>(49)</span> "/var/www/Kohana/APP_PATH/Demo/Init.php"</pre></td>
						</tr>
...
</span><span class="line"><span class="number">102</span> 	require SYS_PATH.'Class/Kohana'.EXT;
...
</span><span class="line highlight"><span class="number">106</span> require APP_PATH.'bootstrap'.EXT;
</span></code></pre></code></pre>
							</li>
							</ol>
	</div>
	...
	<div id="error4ac2453378034environment" class="content collapsed">
		...
		<div id="error4ac2453378034environment_included" class="collapsed">
			<table cellspacing="0">
								<tr>
					<td><code>WEB_PATH/index.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/base.php</code></td>
								...
								<tr>
					<td><code>SYS_PATH/Class/Kohana/core.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana.php</code></td>
				</tr>
								<tr>
					<td><code>APP_PATH/bootstrap.php</code></td>
								...
								<tr>
					<td><code>SYS_PATH/Class/profiler.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/profiler.php</code></td>
				</tr>
								<tr>

					<td><code>SYS_PATH/Class/Kohana/log.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/config.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/log/file.php</code></td>

				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/log/writer.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/Config/File.php</code></td>
				</tr>
								<tr>

					<td><code>SYS_PATH/Class/Kohana/Config/Reader.php</code></td>
				</tr>
								<tr>
					<td><code>MOD_PATH/codebench/init.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/route.php</code></td>

				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/route.php</code></td>
				</tr>
								<tr>
					...
					<td><code>SYS_PATH/Class/request.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/request.php</code></td>
				</tr>
								<tr>
					<td><code>APP_PATH/Class/controller/hello.php</code></td>

				</tr>
								<tr>
					<td><code>SYS_PATH/Class/controller/template.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/controller/template.php</code></td>
				</tr>
								<tr>

					<td><code>SYS_PATH/Class/controller.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/controller.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/view.php</code></td>

				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/view.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/view/exception.php</code></td>
				</tr>
								<tr>

					<td><code>SYS_PATH/Class/Kohana/exception.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/I18N.php</code></td>
				</tr>
								<tr>
					<td><code>SYS_PATH/Class/Kohana/I18N.php</code></td>

				</tr>
								<tr>
					<td><code>SYS_PATH/View/Kohana/Error.php</code></td>
				</tr>
							</table>
		</div>
