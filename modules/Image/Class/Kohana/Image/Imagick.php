...
class Kohana_Image_Imagick extends Image {
	...
	protected function _do_watermark(Image $image, $offset_x, $offset_y, $opacity)
	{
		...
		return $this->im->compositeImage($watermark, Imagick::COMPOSITE_DIAuthLVE, $offset_x, $offset_y);
	}
	...
	protected function _do_background($r, $g, $b, $opacity)
	{
		...
		if ($background->compositeImage($this->im, Imagick::COMPOSITE_DIAuthLVE, 0, 0))
		{
