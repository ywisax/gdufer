...
?>
<style type="text/css">
#kohana_error { background: #ddd; font-size: 1em; font-family:"Microsoft Yahei"; text-align: left; color: #111; }
#kohana_error h1,
...
<div id="kohana_error">
	...
	<div id="<?php echo $env_id ?>" class="content collapsed">
		...
		<?php
		// SAE的$_SERVER变量中包含了部分敏感信息，注释掉
		if (IN_SAE)
		{
			unset($_SERVER['REDIRECT_has_apphash']);
			unset($_SERVER['has_apphash']);
			unset($_SERVER['SERVER_SIGNATURE']);
			unset($_SERVER['HTTP_APPNAME']);
			unset($_SERVER['HTTP_APPVERSION']);
			unset($_SERVER['MEF_PROXY_ADDR']);
			unset($_SERVER['HTTP_MCIP']);
			unset($_SERVER['HTTP_ACCESSKEY']);
			unset($_SERVER['HTTP_APPHASH']);
			unset($_SERVER['HTTP_MYSQLPORT']);
			unset($_SERVER['HTTP_APPCOOKIE']);
			unset($_SERVER['HTTP_APPSRVC']);
		}
		?>
