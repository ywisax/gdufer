...
class Kohana_Upload {
	...
	const FILE_NAME_MATCH = '/\s+/u';
	const FILE_NAME_REPLACE = '_';
	...
	public static function save(array $file, $filename = NULL, $directory = NULL, $chmod = 0644)
	{
		...
		if (Upload::$remove_spaces === TRUE)
		{
			...
			$filename = preg_replace(Upload::FILE_NAME_MATCH, Upload::FILE_NAME_REPLACE, $filename);
		}
	...
	public static function size(array $file, $size)
	{
		...
		{
			// 大于PHP允许的文件大小(upload_max_filesize)
			return FALSE;
		}
